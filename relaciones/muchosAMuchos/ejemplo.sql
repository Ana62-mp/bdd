...
--insert into productos_por_proveedor(pp_codigo_producto, pp_codigo_proveedor, precio)
--values(300,1,0.58); 
-- ERROR PORQUE NO SE PUEDE REPETIR, ES PK

select * from productos_por_proveedor

--LAS DOS TABLAS (PRODUCTOS Y PROVEEDORES NO ESTAN RELACIONADAS)
-- TIENEN A productos_por_proveedor QUE LAS RELACIONA
--configuro asi primero
select * from productos prod, proveedores prov, productos_por_proveedor pp
where prod.codigo = pp.pp_codigo_producto and prov.codigo = pp.pp_codigo_proveedor
